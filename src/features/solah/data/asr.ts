      ...
      entries: [
        {
          ...
          media: {
            image: "/assets/solah/asr/step-1-qiyam.png",
        ...
        },
        {
          ...
          media: { audio: "/audio/solah/asr/qiyam-fatiha.mp3" },
        },
      ],
    },
    {
      ...
      entries: [
        {
          ...
          media: {
            image: "/assets/solah/asr/step-2-ruku.png",
      ...
      entries: [
        {
          ...
          media: {
            image: "/assets/solah/asr/step-4-sujud.png",
      ...
      entries: [
        {
          ...
          media: {
            image: "/assets/solah/asr/step-5-jalsah.png",
      ...
      entries: [
        {
          ...
          media: {
            image: "/assets/solah/asr/step-6-tashahhud.png",
...
export const totalAsrSteps = asrGuide.items.length;
