      ...
      entries: [
        {
          ...
          media: {
            image: "/assets/solah/dhuhr/step-1-qiyam.png",
      ...
      entries: [
        {
          ...
          media: {
            image: "/assets/solah/dhuhr/step-2-ruku.png",
      ...
      entries: [
        {
          ...
          media: {
            image: "/assets/solah/dhuhr/step-4-sujud.png",
      ...
      entries: [
        {
          ...
          media: {
            image: "/assets/solah/dhuhr/step-5-jalsah.png",
      ...
      entries: [
        {
          ...
          media: {
            image: "/assets/solah/dhuhr/step-6-tashahhud.png",
