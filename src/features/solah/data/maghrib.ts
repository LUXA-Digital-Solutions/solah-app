...
const solahName = "Maghrib";

export const maghribGuide: SolahGroup = {
  solah: solahName,
  description: {
    en: "Evening solah",
  },
      ...
      entries: [
        {
          ...
          media: {
            image: "/assets/solah/maghrib/step-1-qiyam.png",
        ...
        },
        {
          ...
          media: { audio: "/audio/solah/maghrib/qiyam-fatiha.mp3" },
        },
      ],
    },
    {
      ...
      entries: [
        {
          ...
          media: {
            image: "/assets/solah/maghrib/step-2-ruku.png",
      ...
      entries: [
        {
          ...
          media: {
            image: "/assets/solah/maghrib/step-4-sujud.png",
      ...
      entries: [
        {
          ...
          media: {
            image: "/assets/solah/maghrib/step-5-jalsah.png",
      ...
      entries: [
        {
          ...
          media: {
            image: "/assets/solah/maghrib/step-6-tashahhud.png",
...
export const totalMaghribSteps = maghribGuide.items.length;
